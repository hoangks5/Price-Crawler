...
while True:    
    th = []
    for token in TOKENS:
        th.append(threading.Thread(target=get_binance_price,args={token,}))
        th.append(threading.Thread(target=get_coinbase_price,args={token,}))
        th.append(threading.Thread(target=get_gateio_price,args={token,}))
        th.append(threading.Thread(target=get_kucoin_price,args={token,}))
        th.append(threading.Thread(target=get_coinmarketcap_price,args={token,}))
        th.append(threading.Thread(target=get_coingecko_price,args={token,}))
